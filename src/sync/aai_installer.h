 ...
 * AAIInstaller
 * ------------
 * Owns the four bridge AAI instances (Thermostat, OnOff, FanControl,
 * Humidity) and handles CHIP AAI registry plumbing on Init/Shutdown.
 *
 ...
 * turn owned by SyncCoordinator. CHIP's registry holds raw pointers; as long as
 * the installer outlives Shutdown, those pointers stay valid.
 *
