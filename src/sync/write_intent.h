 ...
 * accepts from Matter controllers. Mirrors the externalised attributes
 * 1-to-1; mode-aware routing (e.g. "what does writing
 * OccupiedHeatingSetpoint mean in Auto mode?") is the reconciler's job,
 * not the intent's.
 *
