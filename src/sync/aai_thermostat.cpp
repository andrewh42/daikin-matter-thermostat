                                                 ...
                                                 AttributeValueEncoder& encoder)
{
    ...
    case TAttr::LocalTemperature::Id:
        return encoder.Encode(mStack->ReadLocalTemperature());
    case TAttr::OutdoorTemperature::Id:
        return encoder.Encode(mStack->ReadOutdoorTemperature());
    case TAttr::OccupiedHeatingSetpoint::Id:
        return encoder.Encode(mStack->ReadOccupiedHeatingSetpoint());
    case TAttr::OccupiedCoolingSetpoint::Id:
        return encoder.Encode(mStack->ReadOccupiedCoolingSetpoint());
    case TAttr::SystemMode::Id:
        return encoder.Encode(mStack->ReadSystemMode());
    case TAttr::ThermostatRunningMode::Id:
        return encoder.Encode(mStack->ReadRunningMode());
    case TAttr::SetpointChangeSource::Id:
        return encoder.Encode(mStack->ReadSetpointChangeSource());
