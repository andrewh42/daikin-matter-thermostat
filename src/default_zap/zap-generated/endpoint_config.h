...
#define GENERATED_MIN_MAX_DEFAULTS                                             \
  {                                                                            \
    ...
    {(uint16_t)0x10, (uint16_t)0x0,                                            \
     (uint16_t)0x3F}, /* HVACSystemTypeConfiguration */                        \
        ...
        {(uint16_t)0x5DC, (uint16_t)-0x6AB3,                                   \
         (uint16_t)0x7FFF}, /* MinHeatSetpointLimit */                         \
        {(uint16_t)0xAF0, (uint16_t)-0x6AB3,                                   \
        ...
        {(uint16_t)0x14, (uint16_t)0x0,                                        \
         (uint16_t)0x7F}, /* MinSetpointDeadBand */                            \
  ...
  {                                                                            \
    ...
    {ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY),                      \
     ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                    \
        ...
        {ZAP_SIMPLE_DEFAULT(0x00), 0x00000000, 1, ZAP_TYPE(BITMAP8),           \
        ...
        {ZAP_SIMPLE_DEFAULT(1500), 0x00000003, 2, ZAP_TYPE(TEMPERATURE),       \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* AbsMinHeatSetpointLimit */          \
        {ZAP_SIMPLE_DEFAULT(2800), 0x00000004, 2, ZAP_TYPE(TEMPERATURE),       \
        ...
        {ZAP_SIMPLE_DEFAULT(35), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),            \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                       \
        {ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                 \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                \
             ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */              \
        ...
        {ZAP_SIMPLE_DEFAULT(0x07), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),          \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                       \
...
#define GENERATED_ENDPOINT_TYPES                                               \
  { {ZAP_CLUSTER_INDEX(0), 15, 23}, {ZAP_CLUSTER_INDEX(15), 9, 64}, }
...
#define FIXED_DEVICE_TYPES                                                     \
  {                                                                            \
    {0x00000012, 1}, {0x00000016, 4}, { 0x00000072, 1 }                        \
  }
